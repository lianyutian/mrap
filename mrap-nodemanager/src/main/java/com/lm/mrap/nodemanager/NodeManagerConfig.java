...
public class NodeManagerConfig {
    ...
    public static final int NODE_MANAGER_SESSION_TIMEOUT = CommonConfig.getIntegerConfigOrElse("nodemanager.sessionTimeout", 60000);

    public static final int NODE_MANAGER_CONNECT_TIMEOUT = CommonConfig.getIntegerConfigOrElse("nodemanager.connecTimeout", 60000);
